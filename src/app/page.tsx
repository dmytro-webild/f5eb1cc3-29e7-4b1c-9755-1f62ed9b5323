...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      description="Frictionless, scalable, industrial-grade packaging solutions. Elevate your brand with custom materials and high-speed production."
      buttons={[
        {
          text: "Get Quote",
          href: "#contact",
      ...
      slides={[
        ...
        },
        {
          ...
          imageAlt: "Packaging tech",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/side-view-male-barista-coffee-shop_23-2148523047.jpg",
  ...
  <div id="about" data-section="about">
      ...
      description={[
        "Our process bridges the gap between material innovation and high-volume packaging production. We offer a modern path for businesses seeking reliability and premium quality finish.",
        "Leverage our advanced custom pouch configurations to streamline your supply chain and reduce manufacturing friction.",
      ]}
    />
  </div>
      ...
      features={[
        {
          ...
          author: "R&D Team",
          description: "High-barrier films tailored for specific product longevity and safety standards.",
          tags: [
            "Innovation",
            "Durability",
          ],
        ...
        },
        {
          ...
          author: "Production",
          description: "Optimized assembly lines ensuring consistent quality at scale for every order.",
          tags: [
            "Scalability",
            "Speed",
          ],
        ...
        },
        {
          ...
          author: "Tech Lab",
          description: "Digitally integrated platform to design and configure your bespoke packaging solutions.",
          tags: [
            "Tech",
            "Customization",
          ],
      ...
      products={[
        {
          ...
          rating: 5,
          reviewCount: "120",
          imageSrc: "http://img.b2bpic.net/free-photo/still-life-with-oil-painting-tubes_23-2149629997.jpg",
        },
        {
          id: "p2",
          brand: "Durable",
          ...
          rating: 5,
          reviewCount: "85",
          imageSrc: "http://img.b2bpic.net/free-photo/white-paper-package-bottle-liquid_23-2147935421.jpg",
        },
        {
          id: "p3",
          brand: "Eco",
          name: "Paper-Barrier Pouch",
          price: "Custom Pricing",
          rating: 4,
          reviewCount: "210",
        ...
        },
        {
          id: "p4",
          brand: "Custom",
          name: "Shape-Specific Pouch",
          price: "Custom Pricing",
          rating: 5,
          reviewCount: "45",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-toilet-bag-with-products-arrangement_23-2149879992.jpg",
        },
        {
          id: "p5",
          brand: "Barrier",
          name: "Multi-Layer Pouch",
          price: "Custom Pricing",
          rating: 5,
          reviewCount: "150",
        ...
        },
        {
          ...
          rating: 4,
          reviewCount: "95",
          imageSrc: "http://img.b2bpic.net/free-photo/spooky-man-showing-small-tablet_23-2147686731.jpg",
        },
      ]}
      ...
      metrics={[
        {
          ...
          description: "Reliable throughput for enterprise-grade orders.",
        ...
        },
        {
          ...
          description: "Proven experience in diverse packaging sectors.",
          imageSrc: "http://img.b2bpic.net/free-photo/minimalist-abstract-gradient-green-layers-paper_23-2148793009.jpg",
        },
        {
          id: "m3",
          value: "25%+",
          title: "Sustainability Gain",
          description: "Reduction in material impact through innovation.",
          imageSrc: "http://img.b2bpic.net/free-photo/elevated-view-graph-with-natural-resources-icon-desk_23-2147826559.jpg",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Sarah J.",
          handle: "@procurement",
          testimonial: "The configurator dashboard changed our workflow entirely.",
        ...
        },
        {
          ...
          name: "Mark D.",
          handle: "@opsmanager",
          testimonial: "Unbeatable uptime and consistent quality across all batches.",
        ...
        },
        {
          ...
          name: "Emily R.",
          handle: "@production",
          testimonial: "Innovation that feels professional and truly scalable.",
        ...
        },
        {
          ...
          name: "David K.",
          handle: "@designlead",
          testimonial: "Exceptional material quality for high-barrier needs.",
        ...
        },
        {
          ...
          name: "Chris B.",
          handle: "@qaexpert",
          testimonial: "The precision in their retort pouch manufacturing is unmatched.",
          imageSrc: "http://img.b2bpic.net/free-photo/factory-staff-member-overseeing-heavy-tools-near-welding-sparks-using-tablet-using-protective_482257-135636.jpg",
        },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "How do I configure my pouch?",
          content: "Our dashboard provides an automated step-by-step UI to select materials and dimensions.",
        },
        {
          id: "q2",
          title: "What is the lead time?",
          content: "Lead times vary by customization level but generally run 4-6 weeks for high-volume orders.",
        },
        {
          id: "q3",
          title: "Are you sustainable?",
          content: "Yes, we focus on eco-conscious barriers and material-reduction designs across our portfolio.",
        },
      ]}
